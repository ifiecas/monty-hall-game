...
with col2:
    ...
    if st.session_state.final_choice is not None:
        ...
        if prize == '🚗':
            ...
            st.info("📊 By staying, you had only a **1/3 chance (33%)** of winning the car. Since you first picked randomly, there was only a **1 in 3 chance** that your chosen door had the car. The other two doors together had a **2/3 chance (67%)** of hiding the car. When the host revealed a goat, the remaining closed door had a much higher probability of winning. This is why switching is the better choice!")
